...
// "The Merickan Way" is identical on every service page, so it lives in the
// template as a fixed, designed section rather than per-service data.
const MERICKAN_WAY = [
  {
    n: "01",
    title: "Collaborate",
...
export default function ServiceBody({ service }: { service: ServiceView }) {
  ...
  return (
    <>
      ...
      {/* The Merickan Way — fixed, on every service page */}
